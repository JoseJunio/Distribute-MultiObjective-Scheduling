...
public class Individual implements Comparable<Individual>{
	...
	public static List<Individual> crossover_two_point(List<Tuple> parents, int generation, float makespan, int numTasks) {
		List<Individual> childs = new ArrayList();
	...
	public static List<Individual> crossover_uniform_unique(List<Tuple> parents, int generation, float makespan, int numTasks) {
		List<Individual> childs = new ArrayList();
	...
	public static List<Individual> crossover_uniform_multiple(List<Tuple> parents, int generation, float makespan, int numTasks) {
		List<Individual> childs = new ArrayList();
	...
	public void apply_mutation_uniform(int mutationFactor, float currentMakespan) {
